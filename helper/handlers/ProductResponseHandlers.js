    ...
    static updateResponse(err, data, result){
        if(err){
            ...
            if(result == null){
                responseStruct.http = response.statusCode.fetch
                responseStruct.status = response.generalMessage.failedStatus
                responseStruct.message = response.productMessage.updateFailed
                responseStruct.data = null
                return responseStruct
            }else{
                responseStruct.http = response.statusCode.fetch
                responseStruct.status = response.generalMessage.successStatus
                responseStruct.message = response.productMessage.updateSuccess
                responseStruct.data = data
                return responseStruct
            }
        }
    ...
    static deleteResponse(err, data, result){
        if(err){
            ...
            if(result == null){
                responseStruct.http = response.statusCode.fetch
                responseStruct.status = response.generalMessage.failedStatus
                responseStruct.message = response.productMessage.deleteFailed
                responseStruct.data = null
                return responseStruct
            }else{
                responseStruct.http = response.statusCode.fetch
                responseStruct.status = response.generalMessage.successStatus
                responseStruct.message = response.productMessage.deleteSuccess
                responseStruct.data = data
                return responseStruct
            }
        }
